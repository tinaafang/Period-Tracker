...
public interface PeriodRepository extends JpaRepository<Period, Integer> {
    ...
    @Query(nativeQuery = true, value = """
            ...
            and START_DATE > :oneYearAgo
            """)
    ArrayList<ArrayList> getCycleStats(Integer userId, Date oneYearAgo);
    ...
    @Query(nativeQuery = true, value = """
            ...
            """)
    ArrayList<ArrayList> getPeriodStats(Integer userId, Date oneYearAgo);
